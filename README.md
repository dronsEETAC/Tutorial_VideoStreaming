...
Local: emisor y receptor (o receptores) conectados en la misma red de área local
Global: emisor y receptor (o receptores) conectados a Internet
WebApp: receptor conectado a una WebApp (es un caso particular del anterior)
